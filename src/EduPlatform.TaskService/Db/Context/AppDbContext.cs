    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<TaskEntity>().HasData(
            ...
            new TaskEntity
            {
                ...
                Description = "Вам был предоставлен скомпилированный файл, который содержит загаданное число. Ваша задача - найти это число, не обращая внимания на исходный код. Вы можете использовать любые доступные вам инструменты для анализа файла, но помните, что вы не можете изменять его. Ваша цель - определить загаданное число, используя только статистические данные, полученные из анализа файла.",
                Answer = "58",
